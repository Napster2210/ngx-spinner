A library with more than 50 different loading spinners for Angular 4 - 18. (https://napster2210.github.io/ngx-spinner/)
...
| Angular 18  | Angular 17  | Angular 16  | Angular 15  |
| ----------- | ----------- | ----------- | ----------- |
| >=`v18.0.0` | >=`v17.0.0` | >=`v16.0.2` | >=`v15.0.1` |
