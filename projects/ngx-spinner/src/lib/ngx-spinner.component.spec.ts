import { ChangeDetectionStrategy, ChangeDetectorRef, SimpleChange } from '@angular/core';
import { async, ComponentFixture, ComponentFixtureAutoDetect, TestBed, waitForAsync } from '@angular/core/testing';
  ...
  describe('the bdColor input', () => {
    describe('when not specified', () => {
      it('should set the default background color', () => {
        ...
        elementStyle = getComputedStyle(fixture.nativeElement.querySelector('.ngx-spinner-overlay'));
  ...
  describe('the size input', () => {
    describe('when not specified', () => {
      it('should set the appropriate class', () => {
        ...
        const parentElement = fixture.debugElement.nativeElement.querySelector('.ngx-spinner-overlay');
  ...
  describe('the color input', () => {
    describe('when not specified', () => {
      it('should set the default #fff color', () => {
        ...
        const parentElement = fixture.debugElement.nativeElement.querySelector('.ngx-spinner-overlay');
        const childElementStyle = getComputedStyle(parentElement.querySelector('div'));
  ...
  describe('the type input', () => {
    describe('when not specified', () => {
      it('should set the appropriate class', () => { 
        ...
        const parentElement = fixture.debugElement.nativeElement.querySelector('.ngx-spinner-overlay');
        const childElement = parentElement.querySelector('div');
        expect(childElement.getAttribute('class')).toContain('la-ball-scale-multiple');
      });
    });
  ...
  describe('the zIndex input', () => {
    describe('when not specified', () => {
      it('should set the default zIndex value', () => {
        ...
        elementStyle = getComputedStyle(fixture.nativeElement.querySelector('.ngx-spinner-overlay'));
        const secondElementStyle = getComputedStyle(fixture.nativeElement.querySelector('.loading-text'));
  ...
  describe('the disableAnimation input', () => {
    describe('when not specified', () => {
      it('should not set the ng-animate-disabled class', () => {
        ...
        const element = fixture.debugElement.nativeElement.querySelector('.ngx-spinner-overlay');
        expect(element.getAttribute('class')).not.toContain('ng-animate-disabled');
      });
    });
